...
public class Main {
	...
	public static void main(String[] args){
		 ...
		 * but if you do, it is possible to create an "bad" path, ex: we can't go from 0 to 10 ft/s in 6 inches,
		 ...
		 * (technically you could also increase distance, but you probably don't want to, as that would mess up the path)
		*/
