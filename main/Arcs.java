...
public class Arcs {
	public void drawArcPath(String filename,double totalDegrees,double radius) {
		...
		System.out.println("testVel: "+testVel+" overMaxVel? "+(testVel>velocityMax)+" timeUntilMaxVel: "+triTime+" steps: "+triSteps+" doubleTriDist: "+doubleTriDist+" timeAtMaxVel: "+timeAtMaxVel);
